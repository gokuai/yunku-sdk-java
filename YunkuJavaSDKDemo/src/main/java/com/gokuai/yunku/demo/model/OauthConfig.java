package com.gokuai.yunku.demo.model;
...
public class OauthConfig {
	...
	public static OauthConfig create(String jsonString) {
        ...
        OauthConfig data = new OauthConfig();
	...
	public String toString() {
		return "OauthConfig [code=" + code + ", error=" + error + ", token="
				+ access_token + "]";
	}
